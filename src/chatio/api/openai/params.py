...
class OpenAIParams:
    def __init__(self, params: ApiParams, formatter: ApiFormat):
        self._params = params
        self._format = formatter

    @property
    def system(self) -> ChatCompletionMessageParam | None:
    ...
    @property
    def tool_choice(self) -> ChatCompletionToolChoiceOptionParam | None:
    ...
    @property
    def prediction(self) -> ChatCompletionPredictionContentParam | None:
        if self._params.predict is None:
            return None

        return self._format.prediction_content(self._format.text_chunk(self._params.predict.text))
